...
require_once('wp-content/themes/activeclean1/model/Zcustomer_db.php');
require_once('wp-content/themes/activeclean1/model/Zaddress_db.php');
require_once('wp-content/themes/activeclean1/model/Zproduct_db.php');
...
if ($action == NULL) {
    ...
    if ($action == NULL) {        
        $action = 'view_login';
        // default to view login
        if (isset($_SESSION['user'])) {
            $action = 'view_account';
        } // if session is set, view account
        // bare bones logic, we either get to login
        // if the user is set (during registration or login)
        // we view our account
    }
}
...
/*
* we must remember that it is THIS specific new Validate
* and therefore it has THIS specific getFields
* it is an instance of the object
* our new Fields will then addField
*/

/*
* $validate->getFields('return new Fields');
* $validate->new Fields->addField('email');
* $validate->new Fields->$fields['first_name'] = $field;
* $fields['first_name'] = new Field;
*/

/*
* we add each field successively to new Fields
*$fields->getFields()->addField();
*/
...
switch ($action) {
    ...
    case 'register':
        ...
        */
        ...
        // We are taking the literal fields and validating them locally
        /*
        if (!$use_shipping) {
        ...
        */
        ...
        /*
        * The Register button is really registering people.
        * Validates email 
        * Adds customer ID
        * Adds shipping ID
        */
        ...
        */
        ...
        // when it kicks back to this page, we are logged in
