...
if (admin_count() == 0) {
    ...
    // if there are no users in the database we will be able to view the account, or will we, because there are no admins
    ...
    // if a $_SESSION['admin'] is assigned, we will set the action to view_account, only successful if ____
...
switch ($action) {
    ...
    case 'login':
        ...
        // The email address is taken as the session
        } else {
    ...
    case 'view_account':
        ...
        // As an admin, we get to view all accounts
    ...
    case 'create':
        ...
        // So we set the $_SESSION['admin'] here.
        // if it is set, it is redirected ONCE again to here
        // and we get to view our account ---------------------^
