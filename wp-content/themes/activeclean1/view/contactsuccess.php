...
<div id="success">
    <h1>Thank you for contacting Active Clean 1.</h1>
    <hr>
    <h3>We'll get back to you as soon as possible!</h3>
    <h4></h4>
    <p>You can check your email for the details of your inquiry.</p>
    <a href="<?php echo $app_path; ?>?action=contact">Go Back</a>
</div>
    ...
    <footer>
        <div id="footer_wrapper">
            ...
            <div id="footer_bottom">Copyright 2019 All Rights Reserved. Copyright Active Clean 1.</div>
        </div>
    </footer>
