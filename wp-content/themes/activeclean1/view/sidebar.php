<aside>
    ...
    <ul>
        <li>
            ...
            /*
            * Note that account is the primary identifier
            * For all things account related
            * As for app path, it is .
            * And  we don't know how the cart is used yet
            *
            */
            echo "<b>" . $account_url . "</b><br/>";
            echo "<b>" . $logout_url . "</b><br/>";
            echo "<b>" . $app_path . "</b><br/>";
    ...
    <ul>
        <li>
            ...
            <!-- Redirecting to the admin folder -->
        </li>        
    </ul>
</aside>
