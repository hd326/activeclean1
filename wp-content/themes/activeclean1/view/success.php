...
if (!empty($_POST['tid'])) {
    ...
    header('Location: index.php?action=book&bed_range=1&bath_range=1&percentage_range=0&duration_range=');
}*/
if (isset($tid)) {
    $tid = filter_var($tid);
} else {
...
<div id="success">
    ...
    <hr>
    <h3>Your confirmation ID is <?php echo $code; ?>.</h3>
    <p>Check your email for more information.</p>
    <a href="index.php?action=book&bed_range=1&bath_range=1&percentage_range=0&duration_range=">Go Back</a>
</div>
        ...
        <div id="footer_wrapper">
            <div id="footer_contents">
                ...
                <div class="footer_section">
                    <div id="footer_logo">
                        <img src="wp-content/themes/activeclean1/images/logo2.jpg">
                    </div>
                    ...
                    <div id="footer_links">
                        <div class="footer_links_sections">
                            ...
                            <p><a href="index.php?action=about">About Us</a></p>
                            <p>Service Area</p>
                        ...
                        <div class="footer_links_sections">
                            ...
                            <p><a href="index.php?action=contact">Contact Us</a></p>
                        ...
                        <div class="footer_links_sections">
                            ...
                            <!-- needs to be made-->
                            <p>Buy Gift Cards</p>
                            <p><a href="index.php?action=book">Book Now</a></p>
                            <!-- needs -->
                            <p>Cleaning Tips</p>
                        ...
                        <div class="footer_links_sections">
                            ...
                            <!-- have a page already -->
                            <p><a href="index.php?action=contact">Help</a></p>
                            <!--<p>Terms & Conditions</p>-->
                            <p><a href="index.php?action=privacy">Privacy Policy</a></p>
                            <p><a href="index.php?action=questions">FAQ</a></p>
                        </div>
                    </div>
